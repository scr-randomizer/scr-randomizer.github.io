...
<img src="https://img.shields.io/badge/dynamic/json?label=SCR-Randomizer&query=$.status&color=$.color&url=YOUR_RAW_GIST_URL_HERE&query=$&url=data:application/json;base64,e30=" alt="SCR-Randomizer Status"> <br>
