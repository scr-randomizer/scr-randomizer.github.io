...
<img src="https://img.shields.io/badge/dynamic/json?label=SCR-Randomizer&query=$.status&color=$.color&url=gist.github.com&query=$&url=data:application/json;base64,e30=" alt="SCR-Randomizer Status"> <br>
